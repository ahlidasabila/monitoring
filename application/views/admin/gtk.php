...
<div class="page-wrapper">
        ...
        <div class="row">
            <div class="col-12">
                <div style="margin-bottom: 10px">
                    <button type="button" data-toggle="modal" data-target="#modal-tambah-gtk"><span class="fa fa-plus"></span> Tambah User</button>
                    <button type="button" data-toggle="modal" data-target="#modal-hapus"><span class="fa fa-trash"></span> Hapus Semua USer</button>
                </div>
                ...
                <form action="<?= base_url('index.php/tambah/gtk') ?>" method="post" id="formTambahGTK">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="identitas">No Identitas User</label>
                        ...
                        <div class="form-group">
                            ...
                            <select name="level" id="level" class="form-control">
                                ...
                                <option value="2">Dewan Direksi</option>
    ...
    <div class="modal fade" id="modal-hapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Konfirmasi Hapus Semua User</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?= base_url('index.php/hapus/semuaGTK') ?>" id="formHapusSemuaGTK" method="post">
                    <div class="modal-body">
                        <h4>Yakin akan menghapus semua User?</h4>
                        <input type="text" name="xPass" class="form-control" placeholder="Masukkan password">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
